<template>
  <div class="more-page space-y-4 p-5 pb-32">
    ...
    <!-- 新旅行 -->
    <button
      @click="$emit('openNewTrip')"
      class="w-full bg-white rounded-[22px] p-5 flex items-center gap-4 border border-[#6D5FB1]/10 active:scale-[0.98] transition-transform"
    >
    ...
    <button
      ...
      class="w-full bg-gradient-to-r from-[#6D5FB1] to-[#8E82D6] text-white rounded-[22px] p-5 flex items-center gap-4 shadow-lg shadow-[#6D5FB1]/20 active:scale-[0.98] transition-transform"
    >
